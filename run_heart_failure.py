...
def load_heart_failure(data_path):
...
def main():
    ...
    output_dir = Path("./results/heart_failure")

    ensure_dir(output_dir)

    X_train, X_test, y_train, y_test = load_heart_failure(data_path)
    ...
    hof, logbook = run_emoo_optimizer(
        ...
        n_pop=50,
        ngen=100,
        n_estimators_range=np.arange(20, 300, 10),
